...
import { TrendingUp, Users, Facebook, MessageCircle, Target, Trash2, Clock, CalendarIcon, DollarSign, Eye, MousePointer, Megaphone, Building2, Image, ExternalLink, ChevronDown, ChevronUp, Play, Video, ImageIcon, X } from "lucide-react";
          ...
          {loadingAds ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
              {campaignAds.map(ad => {
                ...
                return (
                  <Card key={ad.id} className="overflow-hidden group hover:shadow-lg transition-shadow duration-300 border-border/50 hover:border-primary/30">
                    {/* Media Container */}
