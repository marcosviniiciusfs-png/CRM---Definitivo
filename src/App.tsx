...
import MetaPixelLogs from "./pages/MetaPixelLogs";
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/meta-pixel-logs" element={<ProtectedRoute><DashboardLayout><MetaPixelLogs /></DashboardLayout></ProtectedRoute>} />
