...
-- Returns the granular permissions from the custom role assigned to the current user
...
GRANT EXECUTE ON FUNCTION public.get_member_custom_role_permissions(UUID) TO authenticated;
